...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = KEYMAP_AEK(
        ...
        MT(MOD_LGUI, KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_SCLN, KC_QUOT, KC_H, KC_J, KC_K, KC_L, LT(1, KC_ENTER),
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_SLSH, KC_DOT, KC_N, KC_M, KC_COMM, KC_RSFT,
        KC_LOCKING_CAPS, KC_LALT, KC_LCTL, KC_SPC, KC_RGUI, KC_RALT, KC_RCTL),
    [_FL] = KEYMAP_AEK(
