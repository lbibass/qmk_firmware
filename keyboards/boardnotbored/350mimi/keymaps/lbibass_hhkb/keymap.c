...
/*numpad layer*/
   LAYOUT_60_tsangan_hhkb(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_P7,    KC_P8,    KC_P9,    KC_0,    KC_KP_MINUS, KC_KP_PLUS,  KC_BSLS, KC_GRAVE,
    KC_TAB,  KC_Q,    TO(4),    KC_E,    KC_R,    KC_T,    KC_Y,    KC_P4,    KC_P5,    KC_P6,    KC_KP_EQUAL,    KC_LBRC, KC_RBRC, KC_BSPC,
 ...
 LAYOUT_60_tsangan_hhkb(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_P7,    KC_P8,    KC_P9,    KC_0,    KC_KP_MINUS, KC_KP_PLUS,  KC_BSLS, KC_GRAVE,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_P4,    KC_P5,    KC_P6,    KC_KP_EQUAL,    KC_LBRC, KC_RBRC, KC_BSPC,
