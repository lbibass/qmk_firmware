...
/*numpad layer*/
   LAYOUT_60_ansi_tsangan(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_P7,    KC_P8,    KC_P9,    KC_0,    KC_KP_MINUS, KC_KP_PLUS,  KC_BSPC,
    KC_TAB,  KC_Q,    TO(4),    KC_E,    KC_R,    KC_T,    KC_Y,    KC_P4,    KC_P5,    KC_P6,    KC_KP_EQUAL,    KC_LBRC, KC_RBRC, KC_BSLS,
  ...
  LAYOUT_60_ansi_tsangan(
    ...
    KC_CAPS, RGB_TOG, RGB_MODE_REVERSE,   RGB_MODE_FORWARD, RESET, _______, _______, _______, _______, _______, _______, KC_UP,   _______, KC_BSLS,
 ...
 LAYOUT_60_ansi_tsangan(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_P7,    KC_P8,    KC_P9,    KC_0,    KC_KP_MINUS, KC_KP_PLUS,  KC_BSPC,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_P4,    KC_P5,    KC_P6,    KC_KP_EQUAL,    KC_LBRC, KC_RBRC, KC_BSLS,
...
LAYOUT_60_ansi_tsangan(
    KC_GRAVE, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,KC_DEL,
    KC_CAPS, _______, _______,   _______, RESET, _______, _______, _______, _______, _______, _______, KC_UP,   _______, KC_BSLS,
    _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, _______, _______, _______, _______, KC_LEFT, KC_RGHT, _______,
    _______, _______, _______, _______, _______, HPT_TOG,HPT_DWLI,HPT_DWLD, _______, _______, KC_DOWN, _______,
    _______, _______, _______,                    _______,                    _______, _______,  _______
  ),
